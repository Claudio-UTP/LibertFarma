...
import ClienteTable from './componentsCliente/ClienteTable';
import './App.css'; 
...
const App: React.FC = () => {
  ...
  const obtenerClientes = async () => {
    try {
      ...
      setCliente(respuesta.data); // Actualiza el estado con los datos recibidos
    } catch (error) {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <ClienteTable
        clientes={cliente} // Pasa la lista de clientes al componente de tabla
